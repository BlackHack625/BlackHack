...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To BlackHack625')
	    psb('Congratulations BlackHack625 Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ BlackHack✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel Shujah 8BP YT✓')
